                ...
                <div class="-mx-4 flex flex-wrap">
                    <div class=" px-4 sm:w-2/3 lg:w-3/12 ">
                        <div class="mb-10 w-full">
                            <a href="javascript:void(0)" class="text-2xl font-black uppercase mb-6 inline-block max-w-[160px]">
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                        <div class="mb-10 w-full">
                            ...
                            <div class="mb-6 flex items-center">
                                <a
                                    href="https://www.facebook.com/codeuidesign" target="_blank"
                                ...
                                <a
                                    href="https://twitter.com/progshahidul" target="_blank"
                                    class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                >
                                    <svg
                                        width="16"
                                ...
                                <a
                                    href="https://www.linkedin.com/in/codeui/" target="_blank"
                                    class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                >
                                    <svg
                                        width="14"
                            ...
                            <p class="text-body-color text-base">&copy; 2025 Rider Store</p>
                        </div>
                    </div>
                </div>
            </div>
